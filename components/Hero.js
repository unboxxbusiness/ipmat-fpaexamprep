        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    ...
                    <p className="mt-8 text-base text-black sm:text-xl">IPMAT Excellence Assured: FPAs Unmatched 100% Success Guarantee Program</p>
                ...
                <div>
                    <Image className="w-full" src="/ip1.png" alt="" width={1080} height={1080}/>
                </div>
            </div>
        </div>
    </section>
